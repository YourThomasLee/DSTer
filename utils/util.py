...
def is_exist(file_name):
    """check directory or file is exist or not"""
...
def prepare_device(n_gpu_use):
    ...
    if n_gpu_use > n_gpu:
        ...
        n_gpu_use = n_gpu
    device_type = 'cuda:0' if n_gpu_use > 0 else 'cpu'
    # device_type = 'mps' if device_type == 'cpu' and torch.backends.mps.is_available() else device_type
    if(device_type == 'mps'):
        print("Warning: The process of training will be performed on MPS")
